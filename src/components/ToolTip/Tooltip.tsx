      ...
      {show && (
        <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 z-50">
          <div className="relative bg-[#191F28] rounded-xl shadow-xl px-5 py-4 max-w-sm w-max whitespace-normal break-words">
            <div className="text-[#FFFFFF] text-base font-semibold font-['Pretendard'] leading-tight mb-2">
              {title}
            </div>
            <div className="text-[#FFFFFFB2] text-sm font-normal font-['Pretendard'] leading-tight">
              {description}
            </div>
