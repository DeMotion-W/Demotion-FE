...
export default function BoxStyle({
  ...
  return (
    ...
    >
      ...
      >
        <span className="flex-1 break-words text-left text-sm font-semibold font-['Pretendard'] leading-tight">
          {buttonText || "텍스트를 입력해 주세요."}
        </span>
        <button
          onClick={onClick}
          className="w-12 h-8 rounded-full bg-white flex items-center justify-center cursor-pointer"
        >
